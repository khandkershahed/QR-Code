...
class QrCodeController extends Controller
{
    ...
    public function store(QrCodeRequest $request)
    {
        ...
        $qr_logo_size            = $request->input('qr_logo_size', 65); // Default size if not provided
        ...
        foreach ($formats as $format => $field) {
            ...
            if ($format === 'pdf') {
                ...
                $htmlContent = '<div class="text-center"><img width="350px" src="data:image/png;base64,' . base64_encode($qrCodeImageData) . '" /></div>';
