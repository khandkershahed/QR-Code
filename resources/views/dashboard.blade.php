    ...
    <div class="row gy-5 g-xl-8">
                        ...
                        <div class="row g-0">
                            <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <p class="p-2 mb-0 bg-warning text-white rounded-circle w-30px ps-3 fw-bold">10
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                <div class="d-flex justify-content-between  align-items-center ">
                                    <div>
                                        ...
                                        <a href="#" class="text-primary fw-bold fs-6">Business Cards</a>
                                    </div>


                                    <div>
                                        <p class="p-2 mb-0 bg-primary text-white rounded-circle w-30px ps-3 fw-bold">10
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-xl-4">
            <div class="card card-xl-stretch">
                ...
                <div class="card-body p-0">
                    <div class="card-rounded-bottom bg-info" data-kt-color="info" style="height: 50px"></div>
                    <div class="card-p mt-n20 position-relative">
                        <div class="row g-0">
                            <div class="col bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <p class="p-2 mb-0 bg-success text-white rounded-circle w-30px ps-3 fw-bold">10
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-xl-4">
            <div class="card card-xl-stretch">
                <div class="card-header border-0 bg-success py-5">
                    <h3 class="card-title fw-bolder text-white">Least performing QR codes</h3>
                </div>
                <div class="card-body p-0">
                    <div class="card-rounded-bottom bg-success" data-kt-color="danger" style="height: 50px"></div>
                    <div class="card-p mt-n20 position-relative">
                        <div class="row g-0">
                            <div class="col bg-light-info px-6 py-8 rounded-2 me-7 mb-7">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <a href="#" class="text-info fw-bold fs-6"> SCANS</a>
                                    </div>
                                    <div>
                                        <p class="p-2 mb-0 bg-info text-white rounded-circle w-30px ps-3 fw-bold">10
                                        </p>
                                    </div>
                                </div>
                            </div>
