<x-nfc-card.template :templates="[
    ...
    //     'image' => 'frontend/assets/images/nfc-templates/template_seven.jpg',
    // ],
    // [
    //     'value' => 'template-three',
                        ...
                        <div class="card-header p-0 border-0 border-0">
                            <div class="nfc-one-cover-img-box">
                                <div class="nfc-one-cover-img"
                                    style="
                      background-image: url('https://my.cybercard.ma/uploads/vcards/covers/167/banner-(1).png');
                    ">
                                </div>
                            </div>
                        </div>
                        ...
                        border-width: 6px;
                        border-style: solid;
                        border-image: url('https://img.freepik.com/free-vector/nice-blue-background-about-medical-science_1017-4479.jpg?t=st=1715673477~exp=1715677077~hmac=0797d97fc2cfc933acf53dba7ff33f6a6a77563fb0cae3a077c52092a4854a4d&w=740')
                          30 round;
                      "
                                ...
                                <div class="px-3">
                                    ...
                                    <div>
                                        <div class="" style="margin-top: -45px">
                                            <h2>Robert Bruno</h2>
                                            <h6 class="fw-bolder">Real Estate Broker</h6>
                        ...
                        ">
                          ...
                          color: #1c344f;
                        ">
                                            <i class="fab fa-whatsapp whatsapp-icon icon fa-2x" title="Instagram"></i>
                                        </a>
                                    </div>
                                    <!-- Contact Info -->
                                    <div class="my-3 pt-4">
                                        <div class="row gx-3">
                                            <div class="col-lg-12 mb-3">
                                                <div class="card border-0 contact-info"
                                                            ...
                                                            <div class="col-lg-10 text-center text-lg-start">
                                                                <div class="ps-3 pt-3 pt-lg-0">
                                                                    ...
                                                                    <small class="text-white">
                                                                        <span>demo@example.ma</span> (personal)
                                                                    </small>
                                                                    <small class="text-white">
                                                                        <span>demo@example.ma</span> (work)
                                                                    </small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-10 text-center text-lg-start">
                                                                <div class="ps-3 pt-3 pt-lg-0">
                                                                    ...
                                                                    <small class="text-white">
                                                                        <span>(+880)175*****8</span> (personal)
                                                                    </small>
                                                                    <small class="text-white">
                                                                        <span>(+880)175*****8</span> (work)
                                                                    </small>
                                                                </div>
                                                            </div>
                                                        </div>
                          ...
                          "
                            ...
                            ">
                                    ...
                                    <div class="my-3 text-center">
                                        ...
                                        <p class="pt-2">
                                            <small class="fw-bold">About company</small> <br />
                                            Lorem ipsum dolor sit amet consectetur adipisicing
