                    ...
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-lg-4">
                            <input id="start_time_monday" type="time" class="form-control"
                                ...
                                value="{{ optional($nfc_card->nfcData)->start_time_monday }}"
                                placeholder="Enter time" />
                        </div>
                        <div class="col-lg-4">
                            <input id="end_time_monday" type="time" class="form-control"
                                name="end_time_monday"
                                value="{{ optional($nfc_card->nfcData)->end_time_monday }}"
                                placeholder="Enter time" />
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-lg-4">
                            <input id="start_time_tuesday" type="time" class="form-control"
                                ...
                                value="{{ optional($nfc_card->nfcData)->start_time_tuesday }}"
                                placeholder="Enter time" />
                        </div>
                        <div class="col-lg-4">
                            <input id="end_time_tuesday" type="time" class="form-control"
                                name="end_time_tuesday"
                                value="{{ optional($nfc_card->nfcData)->end_time_tuesday }}"
                                placeholder="Enter time" />
                        </div>
                    </div>
                    <!-- Repeat for other days as needed -->
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-lg-4">
                            <input id="start_time_wednesday" type="time" class="form-control"
                                ...
                                value="{{ optional($nfc_card->nfcData)->start_time_wednesday }}"
                                placeholder="Enter time" />
                        </div>
                        <div class="col-lg-4">
                            <input id="end_time_wednesday" type="time" class="form-control"
                                name="end_time_wednesday"
                                value="{{ optional($nfc_card->nfcData)->end_time_wednesday }}"
                                placeholder="Enter time" />
                        </div>
                    </div>
                    <!-- Repeat for other days as needed -->
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-lg-4">
                            <input id="start_time_thursday" type="time" class="form-control"
                                ...
                                value="{{ optional($nfc_card->nfcData)->start_time_thursday }}"
                                placeholder="Enter time" />
                        </div>
                        <div class="col-lg-4">
                            <input id="end_time_thursday" type="time" class="form-control"
                                name="end_time_thursday"
                                value="{{ optional($nfc_card->nfcData)->end_time_thursday }}"
                                placeholder="Enter time" />
                        </div>
                    </div>
                    <!-- Repeat for other days as needed -->
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-lg-4">
                            <input id="start_time_friday" type="time" class="form-control"
                                ...
                                value="{{ optional($nfc_card->nfcData)->start_time_friday }}"
                                placeholder="Enter time" />
                        </div>
                        <div class="col-lg-4">
                            <input id="end_time_friday" type="time" class="form-control"
                                name="end_time_friday"
                                value="{{ optional($nfc_card->nfcData)->end_time_friday }}"
                                placeholder="Enter time" />
                        </div>
                    </div>
                    <!-- Repeat for other days as needed -->
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-lg-4">
                            <input id="start_time_saturday" type="time" class="form-control"
                                ...
                                value="{{ optional($nfc_card->nfcData)->start_time_saturday }}"
                                placeholder="Enter time" />
                        </div>
                        <div class="col-lg-4">
                            <input id="end_time_saturday" type="time" class="form-control"
                                name="end_time_saturday"
                                value="{{ optional($nfc_card->nfcData)->end_time_saturday }}"
                                placeholder="Enter time" />
                        </div>
                    </div>
                    <!-- Repeat for other days as needed -->
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-lg-4">
                            <input id="start_time_sunday" type="time" class="form-control"
                                ...
                                value="{{ optional($nfc_card->nfcData)->start_time_sunday }}"
                                placeholder="Enter time" />
                        </div>
                        <div class="col-lg-4">
                            <input id="end_time_sunday" type="time" class="form-control"
                                name="end_time_sunday"
                                value="{{ optional($nfc_card->nfcData)->end_time_sunday }}"
                                placeholder="Enter time" />
                        </div>
                    </div>
                    <!-- Repeat for other days as needed -->
