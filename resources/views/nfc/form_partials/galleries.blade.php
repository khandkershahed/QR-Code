            ...
            <div class="modal-body">
                <form class="kt_docs_formvalidation_text form row" action="#" autocomplete="off">
                    <div class="fv-row">
                        ...
                        <input type="text" name="gallery_name" class="form-control form-control-solid mb-3 mb-lg-0"
                            placeholder="" value="" />
                    ...
                    <div class="fv-row">
                        <x-metronic.label for="logo" class="col-form-label fw-bold fs-6 ">{{ __('Gallary Image') }}
                        </x-metronic.label>
