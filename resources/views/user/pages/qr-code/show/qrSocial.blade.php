      ...
      <section>
        <div class="container">
          <div class="row">
            ...
            >
              <div
                class="nfc-mobile-frame shadow-sm"
                style="
              ...
              >
                <div
                  class="card p-0 bg-none border-0 rounded-0 shadow-none bg-transparent"
                  style="overflow-x: hidden"
                >
                  <div
                    class="card-header bg-none border-0 rounded-0 shadow-none bg-transparent p-0"
                  >
                    <div
                      class="text-center text-lg-center mobile-images-profile pt-5"
                    >
                      <img
                        class="p-3 img-fluid "
                        style="
                  ...
                  <div class="card-body p-0">
                    <div>
                      <h1 class="fs-3 text-muted text-center">Folow Us On !</h1>
                      <h1 class="headling-title">My Social Platform</h1>
                    ...
                    <div class="row">
                      <div class="col-lg-6 offset-lg-3 mx-auto">
                        <ul
                          class="d-flex justify-content-center align-items-center ps-0 pt-5"
                          style="list-style-type: none"
                        >
                          <li>
                            <a href=""
                              ><i
                                class="fab fa-facebook link-icon" title="FACEBOOK"
                                style="
                          ...
                          <li>
                            <a href=""
                              ><i class="fab fa-instagram link-icon" title="INSTAGRAM"></i
                            ></a>
                          </li>
                          <li>
                            <a href=""
                              ><i class="fab fa-linkedin link-icon" title="LINKEDIN"></i
                            ></a>
                          </li>
                          <li>
                            <a href=""
                              ><i class="fab fa-twitter link-icon" title="TWITTER"></i
                            ></a>
                          </li>
                        </ul>
                        <ul
                          class="d-flex justify-content-center align-items-center ps-0"
                          style="list-style-type: none"
                        >
                          <li>
                            <a href=""
                              ><i class="fab fa-youtube link-icon" title="YOUTUBE"></i
                            ></a>
                          </li>
                          <li>
                            <a href=""
                              ><i class="fab fa-pinterest link-icon" title="PINTEREST"></i
                            ></a>
                          </li>
                          <li>
                            <a href=""
                              ><i class="fab fa-google link-icon" title="GOOGLE"></i
                            ></a>
                          </li>
                        </ul>
                        <ul
                        ...
                        >
                          <li>
                            <a href=""
                              ><i class="fab fa-whatsapp link-icon" title="WHATSAPP"></i
                            ></a>
                          </li>
                          <li>
                            <a href=""
                              ><i class="fab fa-snapchat link-icon" title="SNAPCHAT"></i
                            ></a>
                          </li>
                        </ul>
                        <ul
                        ...
                        >
                          <li>
                            <a href=""
                              ><i class="fab fa-tiktok link-icon" title="TIKTOK"></i
                            ></a>
                          </li>
                        </ul>
                      </div>
