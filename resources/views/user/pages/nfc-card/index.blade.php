<x-app-layout :title="'NFC Card List'">
    <div class="row">
        <div class="col-lg-12 d-flex  justify-content-between align-items-center bg-white mb-6 p-3 rounded-2 ">
            <div>
                <h2>NFC Cards</h2>
                <p class="mb-0">View and manage your NFC Cards</p>
            </div>
                    ...
                    <table
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr class="odd">
                                ...
                                <td>
                                    <div class="text-success">Ashley James</div>
                                </td>
                                <td>
                                    <div class="text-muted">Bsiness Cards</div>
                                </td>
                                <td class="text-start">
                                    <button class="btn btn-light-primary">94</button>
                                </td>
                                <td class="text-start">
                                    <a href="#" class="text-primary">https://example.com</a>
                                </td>
                                <td class="text-start">
                                    <button class="btn btn-light-primary">Approved</button>
                                </td>
                                <td>
                                    <div class="badge badge-light-success">20 Time</div>
                                </td>
                                <td class="pe-0">
