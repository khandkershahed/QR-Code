                        ...
                        <div class="fv-row col-lg-8">
                            <label class="fw-semibold fs-6 mb-2 d-flex align-items-center">
                                <div>
                                    <svg class="svg-inline--fa fa-left-right fa-fw fa-sm text-muted mr-1"
                                        ...
                                        data-icon="left-right" role="img" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="mt-5">
                                <input type="range" class="form-range w-100" id="customRange1"
                                    name="barcode_width" min="0.5" max="3" step="0.2"
                                    value="2">
                            </div>
                        </div>
                        <div class="fv-row col-lg-2">
                            <label class="fw-semibold fs-6 mb-2 d-flex align-items-center">
                                <div>
                                    <svg class="svg-inline--fa fa-up-down fa-fw fa-sm text-muted mr-1"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="up-down"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        data-fa-i2svg="">
                                        <path fill="currentColor"
