<x-admin-app-layout :title="'Bar Code Generate'">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="py-10">
                <h1 class="text-center mb-0"> <i class="fas fa-barcode fs-1 text-black"></i> Barcode Generator</h1>
            </div>
        </div>
        <div class="w-lg-75 w-100 mx-auto row">
            ...
            <div class="col-lg-4">
                ...
                <label class="btn btn-outline btn-outline-dashed btn-active-light-info p-7 d-flex align-items-center"
                                                ...
                                                <div class="fv-row col-lg-4">
                                                    <label
                                                        ...
                                                        <div><svg
                                                                ...
                                                                data-prefix="fas" data-icon="barcode" role="img"
                                                    ...
                                                    <label
                                                        ...
                                                        <div>
                                                            <svg class="svg-inline--fa fa-up-down fa-fw fa-sm text-muted mr-1"
                                                                aria-hidden="true" focusable="false"
                                                                data-prefix="fas" data-icon="up-down" role="img"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 512 512" data-fa-i2svg="">
                                                                <path fill="currentColor"
                                ...
                                <div class="card-body p-2 py-8">
                                    ...
                                    <div
                                        ...
                                        <div class="text-gray-700 fw-bold">
                                            <small> Make sure to test out your configured barcode before using it in
                                                production.</small>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="fv-row col-lg-8">
                                                    ...
                                                    <input type="file" name="bulk_file" id="fileInput"
                                                        ...
                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                        placeholder="3L Fresh Water" value="" />
                                                    <small>Only CSV and XLSX files allowed. Maximum size: 10 MB.</small>
                                                </div>
                                                ...
                                                <div class="fv-row col-lg-4">
                                                    ...
                                                    <button id="downloadXlsxBtn"
                                                        class="btn btn-primary w-100 rounded-0">Download Now</button>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card xlsx-preview">
                                                        <div class="card-body ps-0">
                                                            <h5>File Preview</h5>
                                                            {{-- By Default Text --}}
                                                            <p id="noFileText">No Chosen File Found, Please Select CSV
                                            ...
                                            <div class="row">
                                                <div class="fv-row col-lg-12">
                                                    ...
                                                    <input type="file" name="bulk_file" id="fileInputpng"
                                                        ...
                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                        placeholder="3L Fresh Water" value="" />
                                                    <small>Only png.jpg,jpeg files allowed. Maximum size: 5 MB.</small>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- Form Action --}}
