<x-admin-app-layout :title="'Dynamic CSS - Admin Panel'">
    <div class="card card-flash">
        ...
        <div class="card-body scroll-y mx-5 mx-xl-15 my-7">
            <!--begin::Form-->
            <form class="form" action="{{ route('admin.css.update', $css->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="fv-row mb-3">
                            ...
                            <div class="row align-items-center">
                                <div class="col-4">
                                    <input name="secondary_bg_color" value="{{ optional($css)->secondary_bg_color }}"
                    ...
                    <div class="col-lg-3">
                        <div class="fv-row mb-3">
                            ...
                            <div class="row align-items-center">
                                <div class="col-4">
                                    <input name="paragraph_color" value="{{ optional($css)->paragraph_color }}"
                    ...
                    <div class="col-lg-3">
                        <div class="fv-row mb-3">
                            ...
                            <input name="paragraph_font_size" value="{{ optional($css)->paragraph_font_size }}"
