                                    ...
                                    <td class="text-center">
                                        <div>
                                            <img class="img-fluid" width="60px"
                                                src="http://127.0.0.1:8000/frontend/assets/images/nfc-templates/template_six.jpg"
                                                alt="">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div>
                                            <img class="img-fluid" width="60px"
                                                src="http://127.0.0.1:8000/frontend/images/virtual_card/virtual_card_8.png"
                                                alt="">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <span class="fw-bolder"> Robert Bruno</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="http://127.0.0.1:8000/frontend/images/virtual_card/virtual_card_10.png"
                                            id="copyButton" class="btn btn-sm btn-primary">Copy URL</a>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#modalId">Delivery Location</button>
                                    </td>
                                    <td class="text-center">
                                        <div
                                ...
                                <table class="table table-striped table-row-bordered gy-5 gs-7">
                                    <thead class="border">
                                        <tr>
                                            ...
                                            <th class="p-3">Robert Brouse</th>
                                        </tr>
                                        <tr>
                                            <th width="40%" class="p-3">Phone</th>
                                            <th class="p-3">(+1)00568 4586</th>
                                        </tr>
                                        <tr>
                                            <th width="40%" class="p-3">Address</th>
                                            <th class="p-3">24/A, Block-C, New York, USA</th>
                                        </tr>
                                        <tr>
                                            <th width="40%" class="p-3">City</th>
                                            <th class="p-3">New York</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th class="p-3">
                                                <p>Please send the card to the address I have provided for delivery.</p>
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
