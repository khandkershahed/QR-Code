<x-admin-app-layout :title="'QR Code Generate'">
    <style>
        #qr-columns-container {
            display: flex;
        }

        #qr-columns-container .col-lg-8,
        #qr-columns-container .col-lg-4 {
            display: flex;
            flex-direction: column;
        }

        #qr-columns-container .content {
            flex: 1;
            display: flex;
            flex-direction: column;
    ...
    <div>
        <div class="row align-items-stretch" id="qr-columns-container">
            <div class="col-lg-8 col-md-7 d-flex">
                <div class="card my-10 p-0 content" id="qr-first-card">
                    <div class="card-body p-0">
                        <div class="stepper stepper-pills" id="kt_stepper_example_clickable">
                            ...
                            <form class="form mx-auto" novalidate="novalidate"
                                action="{{ route('admin.qr-code.store') }}" id="kt_stepper_example_basic_form"
            ...
            <div class="col-lg-4 d-flex">
                <div class="card my-10 p-0 content">
