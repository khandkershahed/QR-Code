<x-admin-app-layout :title="'Add User - Admin Panel'">
    <div class="row">
            ...
            <div class="card card-flash my-15">
                <div class="card-body scroll-y mx-5 my-7">
                    <form class="form" method="POST" action="{{ route('admin.user-management.store') }}">
                        @csrf
                        <div class="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-7">
                                    ...
                                    <x-metronic.input id="name" type="text"
                                        class="form-control-solid mb-3 mb-lg-0" name="name" :value="old('name')"
                                        placeholder="Enter Full name"></x-metronic.input>
                                </div>
                                <div class="col-lg-6 mb-7">
                                    <x-metronic.label for="email"
                                        class="required fw-bold fs-6 mb-2">{{ __('Email') }}</x-metronic.label>
                                    <x-metronic.input id="email" type="email"
                                        class="form-control-solid mb-3 mb-lg-0" name="email" :value="old('email')"
                                        placeholder="example@domain.com"></x-metronic.input>
                                </div>
                                <div class="col-lg-6 mb-7">
                                    <x-metronic.label for="password"
                                        class="required fw-bold fs-6 mb-2">{{ __('Password') }}</x-metronic.label>
                                    <x-metronic.input id="password" type="password"
                                        class="form-control-solid mb-3 mb-lg-0" name="password" :value="old('password')"
                                        placeholder="Enter Password"></x-metronic.input>
                                </div>
                                <div class="col-lg-6 mb-7">
