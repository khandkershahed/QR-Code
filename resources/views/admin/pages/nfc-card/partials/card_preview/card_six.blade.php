<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <div class="punch-card-container" style="background-image: url('https://i.ibb.co/51yxtsc/card-8.png');">
                <div class="row p-5 align-items-center">
                    <div class="col-lg-6 d-flex justify-content-start font">
                        <div class="">
                            ...
                            <h1 class="fw-bold text-white" style="font-size: 4rem;">NFC</h1>
                        </div>
                    </div>
                        ...
                        <div class="text-start content-area font">
                            ...
                            <div>
                                <p class="fw-bold mb-0 text-white">
                                    <i class="fa-solid fa-map-marker-alt pe-2"></i> <span class="card_address">New York, United State</span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="punch-card-container-back" style="background-image: url('https://i.ibb.co/51yxtsc/card-8.png');">
                <div class="row p-5 align-items-center">
