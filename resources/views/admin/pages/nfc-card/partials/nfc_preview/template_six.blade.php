            ...
            <div class="nfc-mobile-frame shadow-sm">
                <div class="card p-0 border-0 shadow-none tem-one-scroll" style="overflow-x: hidden">
                    <div class="card-header p-0 border-0 border-0">
                        <div class="nfc-one-cover-img-box">
                            <div class="nfc-five-cover-img "> <img class="banner_image "
                                    src="https://my.cybercard.ma/uploads/vcards/covers/205/banner-img.png"
                                    width="421px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-0 tem-one-about-content"
                        style="
                      background-image: url(https://my.cybercard.ma/assets/img/vcard14/bg-img.png);
                    ...
                    ">
                        <div class="w-100">
                            ...
                            position: relative;">
                                ...
                                <div class="col-lg-8">
                                    <div class="text-center text-lg-start shadow-sm mobile-profiles"
                                        ...
                                        <div class="p-3">
                                            <h2 class="text-white"
                                                style="font-size: 20px;font-family: var(--tem-one-name-font-family);">
                            ...
                            <div class="row align-items-center gx-0">
                                <p class="text-white text-center px-5 pt-5 bio_description">
                            ...
                            <div class="px-3">
                                ...
                                <div class="my-3 pt-4">
                                    <div>
                                        <p class="text-white text-center rounded-2 py-2 mb-0 fw-bold"
                              ...
                              ">
                                    ...
                                    <div class="row gx-3 align-items-lg-end">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row align-items-center shadow-sm mt-3 p-3">
                                                <div class="col-lg-2 text-center text-lg-start">
                                                    <img class="" style="width: 40px;" src="https://i.ibb.co/ncCd2B1/pngtree-vector-location-icon-png-image-1028445-removebg-preview.png" />
                                                </div>
                                                <div class="col-lg-10 text-center text-lg-start">
                                                    <div class="ps-3 pt-3 pt-lg-0">
                                ...
                                <div class="my-3 pt-4">
                                    <div>
                                        ...
                                        <div
                                            style="background-color: #f44336;height: 23px;width: 25px;border-top-right-radius: 5px;margin-top: -30px;margin-left: -10px;border-bottom-right-radius: 5px;">
                                        </div>
                                    </div>
                                ...
                                <div class="my-3 pt-4 text-start">
                                    ...
                                    <div class="d-flex pt-4">
                                        <div class="px-3 px-lg-0 text-white w-50">
                                            ...
                                            <small class="company_email">company@gmail.com</small><br />
                                ...
                                <div class="pt-4">
                                    ...
                                    <div
                                        style="background-color: #f44336;height: 23px;width: 25px;border-top-right-radius: 5px;margin-top: -30px;border-bottom-right-radius: 5px;">
                                    </div>
                                </div>
                                <div class="py-3">
                                    <ul>
                                        <li class="text-white pb-2 service_one_title">Web Development</li>
                                        <li class="text-white pb-2 service_two_title">Content Writing</li>
                                        <li class="text-white pb-2 service_three_title">Graphich Design</li>
                                    </ul>
                                </div>
                                <div class="pt-4">
                                ...
                                "
                                        ...
                                        <div>
                                            ...
                                            <div class="text-white"
                                                style="background-color: #f44336;border-bottom-left-radius: 10px;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
