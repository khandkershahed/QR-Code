            ...
            <form class="form" action="{{ route('admin.email-settings.update', $emailSetting) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.password-input id="mail_password" name="mail_password" placeholder="Enter mail password" :value="old('mail_password',$emailSetting->mail_password)" required/>

                        {{-- <x-metronic.input id="mail_password" type="text" name="mail_password" :value="old('mail_password',$emailSetting->mail_password)"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <option value="tls" {{ old('mail_encryption',$emailSetting->mail_encryption) == 'tls' ? 'selected' : '' }}>TLS</option>
                ...
                <div class="row">
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="mail_from_address" type="email" name="mail_from_address" :value="old('mail_from_address',$emailSetting->mail_from_address)"
