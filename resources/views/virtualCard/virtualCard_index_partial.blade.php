                        ...
                        <tr>
                            ...
                            <td class="pe-0 text-center">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('user.nfc-card.destroy', $nfc_card->code) }}"
                                        ...
                                        <div class="row p-5 align-items-center" style="height: 33vh;">
                                            <div class="col-lg-6 text-center text-lg-start">
                                                ...
                                                <div class="mt-4 mt-lg-0">
                                                    <img class="punch-card-qr" src="https://i.ibb.co/M7KMQC0/qr.png"
                                                        alt="QR Code"
                                                ...
                                                <div class="text-center text-lg-end content-area">
                                                    ...
                                                    <div>
                                                        <p class="fw-bold mb-0">
                                                            ...
                                                            <i class="fas fa-map-marker-alt tem-one-main-color"></i>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
