                                ...
                                <div class="nfc-two-cover-img-box">
                                    <div class="nfc-one-cover-img">
                                        <img class="nfc-one-cover-img banner_image"
                                            src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/8a6fd685408335.5d7a95b718a67.jpg"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="tem-two-profile d-flex justify-content-around">
                                        <div class="p-3 text-center">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <br />
                                                <small class="tem-two-address phone_personal">+385 91 561
                                                    0409(Work)</small>
                                                <br>
                                                <small class="tem-two-address phone_work">+385 91 561
                                                    0409(Personal)</small>
                                    ...
                                    <div class="row g-x-1">
                                        <div class="card col-6 p-0 border-0 rounded-0">
                                            <div class="p-0 border-0">
                                                <h6
                                                    class="text-center mb-0 p-2 tem-one-services-title service_one_title">
                                                    WEB DEVELOPMENT
                                                </h6>
                                            </div>
                                        ...
                                        <div class="card col-6 p-0 border-0 rounded-0">
                                            <div class="p-0 border-0">
                                                <h6
                                                    class="text-center mb-0 p-2 tem-one-services-title  service_two_title">
                                                    GRAPHIC DESIGN
                                                </h6>
                                            </div>
                                            <div class="card-body p-0">
                                        ...
                                        <div class="card col-6 p-0 border-0 rounded-0">
                                            <div class="p-0 border-0">
                                                <h6
                                                    class="text-center mb-0 p-2 tem-one-services-title  service_three_title">
                                                    GRAPHIC DESIGN
                                                </h6>
                                            </div>
                                            <div class="card-body p-0">
