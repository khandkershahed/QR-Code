                                    ...
                                    <div class="card date-card-tem3">
                                        <div class="card-body d-flex align-content-center p-2">
                                            ...
                                            <div class="ps-3 pt-1">
                                                ...
                                                <p class="text-white mb-0">{{ $nfc_card->nfcData->email_personal }}
                                                </p>
                                                <p class="text-white mb-0">{{ $nfc_card->nfcData->email_work }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card date-card-tem3">
                                        <div class="card-body d-flex align-content-center p-2">
                                            ...
                                            <div class="ps-3 pt-1">
                                                ...
                                                <p class="text-white mb-0">{{ $nfc_card->nfcData->phone_personal }}
                                                </p>
                                                <p class="text-white mb-0">{{ $nfc_card->nfcData->phone_work }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    ...
                                                    <g>
                                                        <path fill="#00dcab"
                                                            ...
                                                            opacity="1" data-original="#00dcab" class="">
                                                        </path>
                                                        <path fill="#1c3b5c"
                                    ...
                                    <div class="card date-card-tem3">
                                        <div class="card-body d-flex align-content-center p-2">
                                            ...
                                            <div class="ps-3 pt-1">
                                                ...
                                                <p class="text-white mb-0">{{ $nfc_card->nfcData->date_of_birth }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
