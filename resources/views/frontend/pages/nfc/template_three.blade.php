...
<head>
    <title>{{ !empty(optional($nfc_card->nfcSeo)->site_title) ? optional($nfc_card->nfcSeo)->site_title : $nfc_card->vcard_name }}</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <meta property="og:site_name" content="{{ !empty(optional($nfc_card->nfcSeo)->site_title) ? optional($nfc_card->nfcSeo)->site_title : $nfc_card->vcard_name }}" />
    ...
    <style>
        ...
        @media (max-width: 480px) {
            .mobile-frame {
                ...
                /* Adjust shadow for smaller devices */
            }
            ...
            <div class="page-content-wrapper">
                ...
                <section>
                    <div class="container px-0">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="image-container-tem3" style="position: relative; width: 100%">
                    ...
                    <div class="container py-5 pt-0">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="d-flex justify-content-center align-items-center profile-image-tem3">
                                    <img width="150px" class="rounded-circle" src="./Back-assets/profile.png"
                                        alt="" />
                                </div>
                            </div>
                        </div>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                ...
                                                <g>
                                                    <linearGradient id="b" x1="24" x2="24"
                                                        y1="4.274" y2="30.545" gradientUnits="userSpaceOnUse">
                                                        <stop offset="0" stop-color="#fd9b02"></stop>
                                                        <stop offset="1" stop-color="#ff7302"></stop>
                                                    </linearGradient>
                                                    <linearGradient id="c" x1="24" x2="24"
                                                        y1="6.108" y2="30.882" gradientUnits="userSpaceOnUse">
                                                    ...
                                                    <linearGradient id="d" x1="16.755" x2="29.756"
                                                        y1="9.755" y2="22.756" gradientUnits="userSpaceOnUse">
                                                        <stop offset="0" stop-color="#4793eb"></stop>
                                                        <stop offset="1" stop-color="#2367ec"></stop>
                                                    </linearGradient>
                                                    <linearGradient id="a" x1="-6.372" x2="34.443"
                                                        y1="-3.856" y2="42.463" gradientUnits="userSpaceOnUse">
                                                        <stop offset="0" stop-color="#fed200"></stop>
                                                        <stop offset="1" stop-color="#f59815"></stop>
                                                    </linearGradient>
                                                    <linearGradient xlink:href="#a" id="e" x1="15.463"
                                                        x2="35.412" y1="28.773" y2="62.365">
                                                    </linearGradient>
                                                    <path fill="url(#b)"
                                        ...
                                        <div>
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                ...
                                                <g>
                                                    ...
                                                    <circle cx="285.999" cy="135.999" r="15" fill="#613d5c"
                                                        opacity="1" data-original="#613d5c"></circle>
                                                    <circle cx="346" cy="135.998" r="15" fill="#613d5c"
                                                        opacity="1" data-original="#613d5c"></circle>
                                                    <g fill="#4b2746">
                                                        <path
                                                            d="M361 135.998c0-8.284-6.716-15-15-15v30c8.284 0 15-6.716 15-15z"
                                                            fill="#4b2746" opacity="1" data-original="#4b2746"
                                                            class=""></path>
                                                        <circle cx="405.999" cy="135.999" r="15" fill="#4b2746"
                                                            opacity="1" data-original="#4b2746" class="">
                                                        </circle>
                                                    </g>
                                                </g>
                                            </svg>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                ...
                                                <g>
                                                    <path fill="#00dcab"
                                                        ...
                                                        opacity="1" data-original="#00dcab" class=""></path>
                                                    <path fill="#1c3b5c"
                                                    ...
                                                    <g fill="#205081">
                                                        <path d="M2672 12484h1015v573H2672zM10561 12484h1016v573h-1016z"
                                                            fill="#205081" opacity="1" data-original="#205081">
                                                        </path>
                                                    </g>
                                                    <g fill="#c5c7cb">
                                                        <path
                                                            ...
                                                            fill="#c5c7cb" opacity="1" data-original="#c5c7cb">
                                                        </path>
                                                    </g>
                                                    <g fill="#fff">
                                                        <path
                                                    ...
                                                    <path fill="#ffc42e" d="M8901 7766h919v173h-919z" opacity="1"
                                                        data-original="#ffc42e"></path>
                                                    <path fill="#ffffff" d="M1937 4011h6142v8143H1937z" opacity="1"
                                                    ...
                                                    <rect width="3025" height="272" x="2499" y="3410"
                                                        fill="#55ace0" rx="214" ry="136" opacity="1"
                                                        data-original="#55ace0"></rect>
                                                    <circle cx="6257" cy="3547" r="170" fill="#ff576b"
                                                        opacity="1" data-original="#ff576b"></circle>
                                                    <circle cx="6860" cy="3547" r="170" fill="#ffc42e"
                                                        opacity="1" data-original="#ffc42e"></circle>
                                                    <circle cx="7464" cy="3547" r="170" fill="#53b4ed"
                                                        opacity="1" data-original="#53b4ed"></circle>
                                                    <path fill="#00dcab" d="M2344 7244h1394v840H2344z" opacity="1"
                                                        data-original="#00dcab" class=""></path>
                                                    <g fill="#afb0b5">
                                                        <path
                                                            d="M2344 8279h943v123h-943zM2344 8535h1117v62H2344zm0 369h840v61h-840zm0-185h1117v62H2344z"
                                                            fill="#afb0b5" opacity="1" data-original="#afb0b5">
                                                        </path>
                                                    </g>
                                                    <path fill="#ff576b" d="M4312 7244h1394v840H4312z" opacity="1"
                                                    ...
                                                    <path fill="#ffc42e" d="M6279 7244h1394v840H6279z" opacity="1"
                                                        data-original="#ffc42e"></path>
                                                    <g fill="#afb0b5">
                                                        <path
                                                    ...
                                                    <path fill="#ffffff" d="M1937 4011h6142v922H1937z" opacity="1"
                                                        data-original="#ffffff"></path>
                                                    <path fill="#ffc42e" d="M1937 4933h6142v2059H1937z" opacity="1"
                                                        data-original="#ffc42e"></path>
                                                    <g fill="#ff576b">
                                                        <circle cx="5008" cy="4402" r="221" fill="#ff576b"
                                                            opacity="1" data-original="#ff576b"></circle>
                                                        <path d="M4840 4709h363.104v54.275H4840z" fill="#ff576b"
                                                    ...
                                                    <path fill="#ff576b" d="M2344 9274h1394v840H2344z" opacity="1"
                                                        data-original="#ff576b"></path>
                                                    <g fill="#afb0b5">
                                                        <path
                                                    ...
                                                    <path fill="#ffc42e" d="M4312 9274h1394v840H4312z" opacity="1"
                                                        data-original="#ffc42e"></path>
                                                    <g fill="#afb0b5">
                                                        <path
                                                    ...
                                                    <path fill="#00dcab" d="M6279 9274h1394v840H6279z" opacity="1"
                                                        data-original="#00dcab" class=""></path>
                                                    <g fill="#afb0b5">
                                                        <path
                                                    ...
                                                    <path fill="#ffffff"
                                                        ...
                                                        opacity="1" data-original="#ffffff"></path>
                                                    <path fill="#ffc42e" d="M8901 10113h919v173h-919z" opacity="1"
                                                        data-original="#ffc42e"></path>
                                                    <path fill="#ffffff"
                                                        d="M10098 10787h1145v173h-1145zM8901 10787h919v173h-919zM8901 11480h1722v173H8901zM10900 11480h919v173h-919z"
                                                        opacity="1" data-original="#ffffff"></path>
                                                    <path fill="#ffc42e" d="M8901 4947h1722v173H8901z" opacity="1"
                                                        data-original="#ffc42e"></path>
                                                </g>
                                            </svg>
                                        </div>
                                                    ...
                                                    <g data-name="Calendar Birthday">
                                                        <g fill="#4294ff">
                                                            <path
                                                                ...
                                                                fill="#4294ff" opacity="1" data-original="#4294ff"
                                                                class=""></path>
                                                        </g>
                                                        <path fill="#e6ecff"
                                                        ...
                                                        <path fill="#4294ff"
                                                            ...
                                                            opacity="1" data-original="#4294ff" class="">
                                                        </path>
                                ...
                                <div class="testimonial-slide">
                                    <div class="testimonial-items">
                                        <div class="row p-3 align-items-center">
                                            <div class="col-sm-3">
                                                <div>
                                                    <img class="img-fluid rounded-2" src="./Back-assets/profile.png"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <div class="col-sm-9">
                      ...
                      ">
                          ...
                          "
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            <textarea name="" class="border-0 form-control form-control-sm rounded-0 w-75 mx-auto rounded-1 p-2"
                                                style="
                            background-color: var(
                              --template-three-color-primary
                            );
                        ...
                        <!-- Qr Code -->
                        <div class="row pt-4">
                            <div class="col-sm-3 mx-auto bg-white p-0 pt-2 pb-3"
                                style="
                    margin-bottom: -15px;
