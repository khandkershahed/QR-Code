                                ...
                                <div class="card-header p-0 border-0 border-0">
                                    <div class="nfc-one-cover-img-box">
                                        <div class="nfc-one-cover-img"
                                            style="
                          background-image: url('https://my.cybercard.ma/uploads/vcards/covers/120/closeup-shot-person-writing-book-with-gavel-table.jpg');
                        ">
                                        </div>
                                    </div>
                                </div>
                            ...
                            ">
                                ...
                                color: #fff;
                              ">
                                                        <i class="fas fa-map-marked-alt icon fa-2x p-3"
                                                            title="Map"></i>
                                                    </a>
                                                    <a href="" class="text-center"
                                                        style="
                                                ...
                                                <div class="row gx-3 align-items-lg-end">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="row align-items-center shadow-sm mt-3 p-3">
                                                            <div class="col-lg-2 text-center text-lg-start">
                                                                <img class=""
                                                                    src="https://my.cybercard.ma/assets/img/vcard16/dob-icon.png" />
                                                            </div>
                                                            <div class="col-lg-10 text-center text-lg-start">
                                                                <div class="ps-3 pt-3 pt-lg-0">
                                                                    <h6 class="text-black mb-0">E-mail</h6>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="p-2 pt-5 text-center">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        version="1.1" width="130" height="130"
                                                                        viewBox="0 0 130 130">
                                                                        <rect x="0" y="0" width="130"
                                                                            height="130" fill="#ffffff"></rect>
                              ...
                              ">
                                                ...
                                                <div class="px-3 px-lg-0">
                                                    <h6 class="fw-bold pt-5">NGen It LTD.</h6>
