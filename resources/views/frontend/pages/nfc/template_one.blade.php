                  ...
                  <div>
                    <div class="d-flex align-items-center">
                      <div class="bg-white p-3">
                        <i
                          class="fa fa-envelope social_icons text-black fs-3"
                        ></i>
                      </div>
                ...
                <div class="col-md-6 mt-4">
                  <div>
                    <div class="d-flex align-items-center">
                      <div class="bg-white p-3">
                        <i
                          class="fa fa-cake-candles social_icons text-black fs-3"
                        ></i>
                      </div>
                      <div class="text-white ps-3">
                ...
                <div class="col-md-6 mt-4">
                  <div>
                    <div class="d-flex align-items-center">
                      <div class="bg-white p-3">
                        <i
                          class="fa-solid fa-flag-usa social_icons text-black fs-3"
                        ></i>
                      </div>
                      <div class="text-white ps-3">
                ...
                <div class="col-lg-12">
                  <div class="text-center">
                    ...
                    <div class="d-flex align-items-center px-5 w-50 mx-auto">
                      ...
                      <span class="divider-tem1-icons text-center"
                        ><i class="fa-solid fa-diamond text-white"></i
                      ></span>
                      <span class="divider-tem1"></span>
                    </div>
                  </div>
                  ...
                  <div class="">
                    <div class="row pt-3 align-items-center">
                      ...
                      <div class="col-md-12">
                        ...
                        >
                          <div>
                            <p class="mb-0">
                              <span
                                ><i class="fa-solid fa-diamond pe-3"></i
                                >www.neezonline.com</span
                              >
                            </p>
                            <p class="mb-0">
                              <span
                                ><i class="fa-solid fa-diamond pe-3"></i>+1
                                98656584584</span
                              >
                            </p>
                          </div>
                          <div>
                            ...
                            <p class="mb-0">
                              <span
                                ><i class="fa-solid fa-diamond pe-3"></i>1184
                      ...
                      <div class="col-md-6 pe-0">
                        <div>
                          <a href="" class="btn btn-dark w-100 rounded-0 mb-2"
                            >Facebook</a
                          >
                          <a href="" class="btn btn-dark w-100 rounded-0 mb-2"
                            >YouTube</a
                      ...
                      <div
                        class="col-md-6 bg-white d-flex justify-content-center mt-0"
                ...
                <div class="col-md-4 me-2">
                  <div class="card border-0">
                    <div class="card-body p-0">
                      <div>
                        <img
                          class="img-fluid rounded-2 product-img-tem1"
