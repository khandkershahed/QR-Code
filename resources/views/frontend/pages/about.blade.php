<x-frontend-app-layout :title="'About Us || GoFlixza - Your Hub for QR, Bar Codes & NFC V.Cards'">
    ...
    <section class="about-features-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000"
                    data-aos-offset="50">
                    <div class="iconic-box style-seven border">
                        <div class="icon-title">
                ...
                <div class="col-xl-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000"
                    data-aos-offset="50">
                    <div class="iconic-box style-seven border">
                        <div class="icon-title">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-6 col-lg-8">
                    <div class="cta-content text-white rmb-35 aos-init" data-aos="fade-left" data-aos-duration="1500"
                        data-aos-offset="50">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item style-six counter-text-wrap aos-init counted aos-animate"
                        data-aos="fade-up" data-aos-duration="1000" data-aos-offset="50">
                        <span class="count-text plus" data-speed="3000" data-stop="1253">1253</span>
                        <hr />
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item style-six counter-text-wrap aos-init counted aos-animate"
                        data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000" data-aos-offset="50">
                        <span class="count-text percent" data-speed="3000" data-stop="83">83</span>
                        <hr />
