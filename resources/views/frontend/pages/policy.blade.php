<x-frontend-app-layout :title="'Policy || GoFlixza - Your Hub for QR, Bar Codes & NFC V.Cards'">
            ...
            <div class="row">
                <div class="col-lg-12 pt-30 pb-30">
                    <div>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                                    this Agreement) refers to goqr, USA.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Go Qr, accessible from <a
                                        href="https://goqr.flixzaglobal.com/" rel="external nofollow noopener"
                                        target="_blank">https://goqr.flixzaglobal.com/</a></p>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>By email: support@qr.mail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
