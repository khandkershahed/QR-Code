<x-frontend-app-layout :title="'Services'">
    ...
    <section class="pricing-area-six bgc-lighter overflow-hidden rel z-1 pt-125 rpt-95 pb-100 rpb-70">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-md-6 col-sm-10" data-aos="fade-up" data-aos-duration="1500"
                    data-aos-offset="50">
                    <div class="pricing-item style-five">
                        <div class="title-price">
                            <h5 class="title">Regular</h5>
                            <div class="price">
                                <span class="prev">$</span>15.<span class="next">/m</span>
                            </div>
                        </div>
                        <hr />
                        <div class="text">
                        ...
                        <ul class="icon-list">
                            <li>
                                <i class="fa-regular fa-circle-check"></i> 2 Limited sites available
                            </li>
                            <li><i class="fa-regular fa-circle-check"></i> 1 GB storage per site</li>
                            <li><i class="fa-regular fa-circle-check"></i> Up to 5 pages per site</li>
                            <li class="hide">
                                <i class="fa-regular fa-circle-check"></i> Free SSL for custom domain
                            </li>
                            <li class="hide">
                                <i class="fa-regular fa-circle-check"></i> Connect custom domain
                            </li>
                        </ul>
                ...
                <div class="col-xl-4 col-md-6 col-sm-10" data-aos="fade-up" data-aos-delay="100"
                    data-aos-duration="1500" data-aos-offset="50">
                    <div class="pricing-item style-five">
                        <div class="title-price">
                            <h5 class="title color-two">Standard</h5>
                            <div class="price">
                                <span class="prev">$</span>35.<span class="next">/m</span>
                            </div>
                        </div>
                        <hr />
                        <div class="text">
                ...
                <div class="col-xl-4 col-md-6 col-sm-10" data-aos="fade-up" data-aos-delay="200"
                    data-aos-duration="1500" data-aos-offset="50">
                    <div class="pricing-item style-five">
                        <div class="title-price">
                            <h5 class="title color-four">Diamond</h5>
                            <div class="price">
                                <span class="prev">$</span>98.<span class="next">/m</span>
                            </div>
                        </div>
                        <hr />
                        <div class="text">
                        ...
                        <ul class="icon-list">
                            ...
                            <li><i class="fa-regular fa-circle-check"></i> Connect custom domain</li>
                        </ul>
                        <a href="#" class="theme-btn style-two">Choose Package <i
                                class="fas fa-arrow-right"></i></a>
                        <div class="footer-text">No credit card required</div>
